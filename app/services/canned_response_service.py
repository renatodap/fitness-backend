...
class CannedResponseService:
    ...
    def __init__(self):
        ...
        self.responses = {
            ...
            # SAFETY-CONSCIOUS RESPONSES (Science-backed intensity)
            "recovery_en": [
                "Rest is where GAINS happen! Your body's rebuilding STRONGER! 💪",
                "Smart training means SMART RECOVERY! You'll come back STRONGER! 🔥",
                "Recovery is where the GAINS happen! Science says so! 💯",
                "Champions know when to REST! Your body's getting STRONGER! 🦾",
            ],
            "recovery_pt": [
                "Descanso é onde os GANHOS acontecem! Seu corpo está ficando MAIS FORTE! 💪",
                "Treino inteligente significa RECUPERAÇÃO INTELIGENTE! Você vai voltar MAIS FORTE! 🔥",
                "Recuperação é onde os GANHOS acontecem! A ciência diz! 💯",
            ],
            "recovery_es": [
                "¡El descanso es donde ocurren las GANANCIAS! ¡Tu cuerpo se está haciendo MÁS FUERTE! 💪",
                "¡Entrenamiento inteligente significa RECUPERACIÓN INTELIGENTE! ¡Volverás MÁS FUERTE! 🔥",
                "¡La recuperación es donde se hacen las GANANCIAS! ¡La ciencia lo dice! 💯",
            ],
            "injury_en": [
                "Smart athletes HEAL FIRST. You'll come back STRONGER! 🔥",
                "Listen to your body! Healing is PROGRESS too! 💪",
                "Recovery today = BEAST MODE tomorrow! Take care! 💯",
                "Champions prioritize HEALTH! Heal up STRONG! 🦾",
            ],
            "injury_pt": [
                "Atletas inteligentes CURAM PRIMEIRO. Você vai voltar MAIS FORTE! 🔥",
                "Escute seu corpo! Cura também é PROGRESSO! 💪",
                "Recuperação hoje = MODO FERA amanhã! Se cuida! 💯",
            ],
            "injury_es": [
                "¡Los atletas inteligentes SANAN PRIMERO! ¡Volverás MÁS FUERTE! 🔥",
